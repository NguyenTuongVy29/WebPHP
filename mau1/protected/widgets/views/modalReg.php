            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="rows">
                       ...
                       <li class="row">
                          <div class="col-sm-6"> 
                           ...
                           <input id="password_reg" type="password" class="form-control">
                            <label id="err_password_reg"  style="color: red" >Mật Khẩu không được để trống!</label>
                           </div>
                       </li>
                       <li class="row">
                          <div class="col-sm-6"> 
                            ...
                            <label id="err_first_name_reg"  style="color: red" >Họ không được để trống! </label>
                          </div>
                           <div class="col-sm-6">
                           <label>Tên</label>
                           <input id="last_name_reg" type="text" class="form-control">
                           <label id="err_last_name_reg"  style="color: red">Tên không được để trống!</label>
                           </div>
                       </li>
                       <li class="row">
                          <div class="col-sm-6"> 
                           ...
                           <label id="err_telephone_reg"  style="color: red" >Số Điện Thoại không được để trống!</label>
                  ...
                  <p id="reg_succ">Đăng ký  thành công! Hãy kiểm tra Email để xác nhận</p>  
                </div>
              </div>
